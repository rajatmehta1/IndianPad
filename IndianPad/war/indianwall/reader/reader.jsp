    ...
    <script type="text/template" id="feed-template">             
        ...
        <div id="myCarousel<%=feedIdElement%>" class="carousel" data-interval="false">
            <div class="carousel-inner">
                ...
                <div id="feedItemsParentDiv<%=feedIdElement%>-3" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-3">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-4" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-4">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-5" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-5">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-6" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-6">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-7" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-7">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-8" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-8">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-9" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-9">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-10" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-10">
                     </div>
                </div>
                <div id="feedItemsParentDiv<%=feedIdElement%>-11" class="item">
                     <div id="feedItemsDiv<%=feedIdElement%>-11">
                     </div>
                </div>
            </div>
